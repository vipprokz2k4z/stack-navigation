...
const LoginScreen = () => {
  ...
  const navigation = useNavigation(); // 🚀 Dùng đúng cách
  ...
  const onContinuePress = () => {
    ...
    Alert.alert('Thông báo', `Số điện thoại bạn nhập: ${phoneNumber}`, [
      { text: 'OK', onPress: () => navigation.navigate('Home') } // 🚀 Chuyển sang HomeScreen
    ]);
  };
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={styles.description}>
          Dùng số điện thoại để đăng nhập hoặc đăng ký tài khoản tại FB88
        </Text>
